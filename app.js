...
var createNewTaskElement=function(taskString) {
  ...
  editInput.type="text";
  editInput.className="task__edit task__input";
...
var editTask = function () {
  ...
  // If class of the parent is .task__li-edit
  if (containsClass) {
  ...
  // Toggle .task__li-edit on the parent.
  listItem.classList.toggle("task__li-edit");
};
...
var taskCompleted = function () {
  ...
  var label = listItem.querySelector("label");
  label.classList.add("complete-task__label");
...
var taskIncomplete = function() {
  ...
  var listItem = this.parentNode;
  incompleteTaskHolder.appendChild(listItem);
  // Remove "complete-task__label" class from the label
  var label = listItem.querySelector("label");
  label.classList.remove("complete-task__label");
  // Update the event binding for the moved task
  bindTaskEvents(listItem, taskCompleted);
};
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  // Bind editTask to both edit and save buttons
